...
<aside class="Hui-aside">
    ...
    <dl id="menu-system">
            <dt><i class="Hui-iconfont">&#xe62e;</i>&nbsp&nbsp供求管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo U('Supply/add');?>" data-title="添加供求" href="javascript:void(0)">添加供求</a></li>
                    <li><a data-href="<?php echo U('Supply/index');?>" data-title="供求管理" href="javascript:void(0)">供求管理</a></li>
            </ul>
        </dd>
    </dl>
    <dl id="menu-system">
            <dt><i class="Hui-iconfont">&#xe62e;</i>&nbsp&nbsp资讯管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo U('News/add');?>" data-title="添加资讯" href="javascript:void(0)">添加资讯</a></li>
                    <li><a data-href="<?php echo U('News/index');?>" data-title="所有资讯" href="javascript:void(0)">所有资讯</a></li>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/miniwajiyeyagzxt/Public/hui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
